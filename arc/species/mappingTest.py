...
class TestMapping(unittest.TestCase):
    ...
    #     spc1 = ARCSpecies(label='[CH2]C(C)CO_a', smiles='[CH2]C(C)CO',
    ...
    #                                       (0.9972006722528377, -0.7025586995487184, -1.3391950754631268),
    #                                       (2.377638769033351, 0.43380253822255727, 0.17647842348371048))})
    #     spc2 = ARCSpecies(label='[CH2]C(C)CO_b', smiles='[CH2]C(C)CO',
    ...
    def test_dfs(self):
        ...
        result = mapping.dfs(adj_elements_1={0: {'self': 'C', 'C': [1]},
                                             1: {'self': 'C', 'H': [4, 3]}},
        ...
        result = mapping.dfs(adj_elements_1={0: {'self': 'C', 'C': [3], 'H': [1, 2]},
