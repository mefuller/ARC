...
def draw_structure(xyz=None, species=None, project_directory=None, method='show_sticks', show_atom_map=False):
    """
...
def show_sticks(xyz=None, species=None, project_directory=None, show_atom_map=False):
    """
