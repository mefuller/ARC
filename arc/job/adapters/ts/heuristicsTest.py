...
class TestHeuristicsAdapter(unittest.TestCase):
    ...
    #     self.assertEqual(len(rxn2.ts_species.ts_guesses), 7)
    ...
    #     self.assertEqual(len(rxn3.ts_species.ts_guesses), 270)
    ...
    #     self.assertEqual(len(rxn6.ts_species.ts_guesses), 8)
    ...
    def test_react(self):
        ...
        rmg_reaction = react(reactants=list(reactants),
